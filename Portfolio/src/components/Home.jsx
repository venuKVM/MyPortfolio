...
export default function Home(){
    return(
        <section className="h-full flex flex-col justify-center bg-[#101d26]">
            ...
            <p className="w-1/2 mx-auto mb-4 mt-2">Full-stack devloper crafting scalable applications. I build efficient and user-friendly web apps with MongoDB, Express.js, React, Next.js and node.js</p>
            <div className="pt-4">
